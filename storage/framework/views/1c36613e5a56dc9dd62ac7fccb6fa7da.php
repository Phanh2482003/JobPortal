      ...
      <div class="card-body p-5">
        ...
        <div class="flex justify-between items-center border-b mb-4 pb-4">
          ...
          <div class="flex gap-3">
            <a href="/company/applications/<?php echo e($application->id); ?>" class="border-2 rounded-lg py-2 px-4 hover:text-black hover:bg-green-50">
        ...
        <div class="row">
          <div class="col-xl-3 col-md-4">
            <div class="w-full mb-2">
              <div
                <?php if($status==='Ứng tuyển' ): ?> class="w-full rounded-lg py-2 px-4 border-2 border-green-200 bg-green-100 text-black"
                <?php else: ?>
            ...
            <div class="w-full mb-2">
              <div
                <?php if($status==='Phỏng vấn chuyên sâu' ): ?> class="w-full rounded-lg py-2 px-4 border-2 border-green-200 bg-green-100 text-black"
                <?php else: ?>
                class="w-full rounded-lg py-2 px-4"
                <?php endif; ?>>
            ...
            <div class="w-full mb-2">
              <div
                <?php if($status==='Phỏng vấn doanh nghiệp' ): ?> class="w-full rounded-lg py-2 px-4 border-2 border-green-200 bg-green-100 text-black"
                <?php else: ?>
                class="w-full rounded-lg py-2 px-4"
                <?php endif; ?>>
            ...
            <div class="w-full">
              <div
                <?php if($status=='Trúng tuyển' || $status=='Không trúng tuyển' ): ?> class="w-full rounded-lg py-2 px-4 border-2 border-green-200 bg-green-100 text-black"
                <?php else: ?>
                class="w-full rounded-lg py-2 px-4"
                <?php endif; ?>>
          ...
          <div class="col-xl-9 col-md-8 px-4 py-2 border-2 rounded-md">
            <?php switch($status):
            case ("Ứng tuyển"): ?>
            <form action="/company/applications/<?php echo e($application->id); ?>/recruitment-process/comment" method="POST">
              <?php echo csrf_field(); ?>
              <div class="py-3">
              ...
              <div class="form-group">
                ...
                <textarea name="comment" class="form-control" placeholder="Ghi chú" rows="5"><?php echo e($comment); ?></textarea>
              </div>
              <div>
                <button type="submit" class="btn btn-info">Cập nhật</button>
                <a
                  href="/company/applications/<?php echo e($application->id); ?>/recruitment-process/update-status"
                  class="btn btn-primary">Chuyển sang phỏng vấn chuyên sâu</a>
              </div>
            </form>
            <?php break; ?>
            <?php case ("Phỏng vấn chuyên sâu"): ?>
            <form action="/company/applications/<?php echo e($application->id); ?>/recruitment-process/comment" method="POST">
              <?php echo csrf_field(); ?>
                  ...
                  <div class="flex gap-3">
                    <div class="col-md-auto d-flex align-items-center gap-3">
                      ...
                      <div class="relative">
                        ...
                        <input type="time" readonly value="<?php echo e($interview->start_time); ?>" class="form-control p-2">
                      </div>
                    </div>
                    <div class="col-md-auto d-flex align-items-center gap-3">
                      ...
                      <div class="relative">
                        ...
                        <input type="time" readonly value="<?php echo e($interview->end_time); ?>" class="form-control p-2">
                      </div>
                    </div>
                    <div class="flex items-center gap-1">
                      ...
                      <div class="relative ms-1">
                        ...
                        <input datepicker-format="dd/mm/yyyy" value="<?php echo e($interview->date); ?>" type="text" readonly class="form-control p-2 ps-5">
                      </div>
                    </div>
                  </div>
                  <?php else: ?>
              ...
              <div class="row mt-4">
                ...
                <div class="table-responsive rounded-lg border w-full col-xl-9 max-lg:mx-2">
                  <table class="table align-items-center mb-0 rounded">
                    ...
                    <tbody>
                      <?php $__currentLoopData = $interviewers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $interviewer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td class="">
                          <p class="text-xs font-weight-bold mb-0"><?php echo e($interviewer['name']); ?></p>
                        </td>
                        <td class="">
                          <p class="text-xs font-weight-bold mb-0"><?php echo e($interviewer['email']); ?></p>
                        </td>
                      </tr>
            ...
            <?php break; ?>
            <?php case ("Phỏng vấn doanh nghiệp"): ?>
            <form action="/company/applications/<?php echo e($application->id); ?>/recruitment-process/comment" method="POST">
              <?php echo csrf_field(); ?>
              <div class="row my-2 items-center">
                <div class="text-sm text-black font-bold col-xl-3">Lịch phỏng vấn:</div>
...
<?php echo $__env->make('company.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Music\Downloads\JobPortal-main\resources\views/company/applications/show-recruitment-process.blade.php ENDPATH**/ ?>