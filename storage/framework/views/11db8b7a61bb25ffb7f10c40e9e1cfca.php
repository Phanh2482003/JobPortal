            ...
            <div class="row">
              <div class="col-md-6 pe-md-5">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Tên chiến dịch" name="name" id="name" value="<?php echo e(old('name')); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="flex items-center gap-3 ms-md-3 mb-2">
                    ...
                    <div class="relative ms-1">
                      ...
                      <input datepicker datepicker-autohide datepicker-format="dd/mm/yyyy" type="text" autocomplete="off" class="form-control p-2 ps-5" placeholder="dd/mm/yyyy" name="start_time" id="campaign_start_time" value="<?php echo e(old('start_time')); ?>">
                    </div>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  <div class="flex items-center gap-3 ms-md-3">
                    ...
                    <div class="relative">
                      ...
                      <input datepicker datepicker-autohide datepicker-format="dd/mm/yyyy" type="text" autocomplete="off" class="form-control p-2 ps-5" placeholder="dd/mm/yyyy" name="end_time" id="campaign_end_time" value="<?php echo e(old('end_time')); ?>">
                    </div>
                  </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Tiêu đề công việc" name="name" id="jobName" value="<?php echo e(old('name')); ?>">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <input type="number" class="form-control p-2" placeholder="0" name="min_salary" id="min_salary" value="<?php echo e(old('min_salary')); ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="d-flex align-items-center gap-3">
                      <label for="max_salary" class="mb-0">Đến</label>
                      <input type="number" class="form-control p-2" placeholder="0" name="max_salary" id="max_salary" value="<?php echo e(old('max_salary')); ?>" required>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="relative">
                  ...
                  <input id="datepicker-format" datepicker datepicker-autohide datepicker-format="dd/mm/yyyy" type="text" autocomplete="off" class="form-control p-2 ps-5" placeholder="dd/mm/yyyy" name="deadline" id="deadline" value="<?php echo e(old('deadline')); ?>">
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.trix-input','data' => ['id' => 'description','placeholder' => 'Mô tả công việc','name' => 'description','value' => ''.e(sanitize_html(old('description'))).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'description','placeholder' => 'Mô tả công việc','name' => 'description','value' => ''.e(sanitize_html(old('description'))).'']); ?>
          ...
          <div class="row">
            <div class="form-group">
              ...
              <div class="">
                <?php if (isset($component)) { $__componentOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.trix-input','data' => ['id' => 'requirement','placeholder' => 'Yêu cầu ứng viên','name' => 'requirement','value' => ''.e(sanitize_html(old('requirement'))).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('trix-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'requirement','placeholder' => 'Yêu cầu ứng viên','name' => 'requirement','value' => ''.e(sanitize_html(old('requirement'))).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1)): ?>
<?php $attributes = $__attributesOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1; ?>
          ...
          <div class="row">
            <div class="form-group">
              ...
              <div class="">
                <?php if (isset($component)) { $__componentOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.trix-input','data' => ['id' => 'benefit','placeholder' => 'Quyền lợi','name' => 'benefit','value' => ''.e(sanitize_html(old('benefit'))).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('trix-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'benefit','placeholder' => 'Quyền lợi','name' => 'benefit','value' => ''.e(sanitize_html(old('benefit'))).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1)): ?>
<?php $attributes = $__attributesOriginalfa45bdf63d5f546beb2b52c7dd7ad0c1; ?>
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Địa chỉ" name="workplace" id="workplace" aria-label="workplace" aria-describedby="workplace" value="<?php echo e(old('workplace')); ?>">
...
<?php echo $__env->make('company.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Music\Downloads\JobPortal-main\resources\views/company/campaigns/create.blade.php ENDPATH**/ ?>