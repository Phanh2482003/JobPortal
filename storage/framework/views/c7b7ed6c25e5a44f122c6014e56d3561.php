    ...
    <div class="col-12">
      <div class="card mb-4 mx-4">
        ...
        <div class="card-body pt-4">
          <form action="/company/users/update/<?php echo e($current_user->id); ?>" method="POST" role="form text-left">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-select" name="role" id="role" aria-label="role" aria-describedby="role">
                    ...
                    <option value="HR" <?php if($current_user->role=="HR" ): ?> selected <?php endif; ?>>HR</option>
                    <option value="MANAGER" <?php if($current_user->role=="MANAGER" ): ?> selected <?php endif; ?>>Trưởng phòng</option>
                  </select>
...
<?php echo $__env->make('company.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Music\Downloads\JobPortal-main\resources\views/company/users/update.blade.php ENDPATH**/ ?>