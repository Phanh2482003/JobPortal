        ...
        <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <?php $__currentLoopData = $latest_jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $latest_job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row g-4">
                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                ...
                                <div class="text-start ps-4">
                                    <h5 class="mb-3"><?php echo e($latest_job->name); ?></h5>
                                    <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo e($latest_job->location); ?></span>
                                    <span class="text-truncate me-3"><i class="fa fa-clock text-primary me-2"></i><?php echo e($latest_job->employment_type); ?></span>
                                    <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i><?php echo e($latest_job->salary); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                <div class="d-flex mb-3">
                                    <a class="btn btn-light btn-square me-3" href=""><i class="far fa-heart text-primary"></i></a>
                                    <a class="btn btn-primary" href="/jobs/<?php echo e($latest_job->id); ?>#job-detail">Xem chi tiết</a>
                                </div>
                                <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Hạn ứng tuyển: <?php echo e($latest_job->deadline); ?></small>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div id="tab-2" class="tab-pane fade show p-0">
                    <?php $__currentLoopData = $popular_jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popular_job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="job-item p-4 mb-4">
                        <div class="row g-4">
                            <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                <div class="text-start ps-4">
                                    <h5 class="mb-3"><?php echo e($popular_job->name); ?></h5>
                                    <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo e($popular_job->location); ?></span>
                                    <span class="text-truncate me-3"><i class="fa fa-clock text-primary me-2"></i><?php echo e($popular_job->employment_type); ?></span>
                                    <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i><?php echo e($popular_job->salary); ?></span>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                <div class="d-flex mb-3">
                                    <a class="btn btn-light btn-square me-3" href=""><i class="far fa-heart text-primary"></i></a>
                                    <a class="btn btn-primary" href="/jobs/<?php echo e($popular_job->id); ?>#job-detail">Xem chi tiết</a>
                                </div>
                                <small class="text-truncate"><i class="far fa-calendar-alt text-primary me-2"></i>Hạn ứng tuyển: <?php echo e($popular_job->deadline); ?></small>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('candidate.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Music\Downloads\JobPortal-main\resources\views/candidate/home.blade.php ENDPATH**/ ?>