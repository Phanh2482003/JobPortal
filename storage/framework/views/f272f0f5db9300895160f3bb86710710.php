      ...
      <form action="/company/recruitment-news/create" method="POST" role="form text-left">
        ...
        <div class="form-group">
          ...
          <select class="form-select" name="campaign_id" id="campaign_id">
            ...
            <option value="<?php echo e($current_campaign->id); ?>" selected><?php echo e($current_campaign->name); ?></option>
            <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row">
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Tiêu đề công việc" name="name" id="name" aria-label="Name" aria-describedby="name" value="<?php echo e(old('name')); ?>">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="relative">
                ...
                <input datepicker datepicker-autohide datepicker-format="dd/mm/yyyy" type="text" autocomplete="off" class="form-control p-2 ps-5" placeholder="dd/mm/yyyy" name="deadline" id="deadline" value="<?php echo e(old('deadline')); ?>">
              </div>
...
<?php echo $__env->make('company.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Music\Downloads\JobPortal-main\resources\views/company/recruitment-news/create.blade.php ENDPATH**/ ?>